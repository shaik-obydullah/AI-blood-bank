<header>
    <div class="container">
        <div class="header-content">
            ...
            <a href="{{ url('/ai/chat') }}" class="btn-become-donor" style="background:var(--accent);margin-left:8px;text-decoration:none;padding:10px 20px;border-radius:5px;color:#fff;display:inline-flex;align-items:center;gap:8px;">
...
<script>
    ...
    function performBloodSearch() {
        ...
        const validBloodTypes = @json(isset($all_blood_groups) ? $all_blood_groups : []);
    ...
    document.addEventListener('keydown', function (e) {
        ...
        if (e.key === 'Escape') {
            const donorPanel = document.querySelector('.donor-panel');
            const dropdown = document.getElementById('donorPanelDropdown');
            if (donorPanel) donorPanel.classList.remove('active');
