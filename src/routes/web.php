...
Route::prefix('ai')->group(function () {
    ...
    Route::post('/check-eligibility', [AiController::class, 'checkEligibility'])->name('ai.check-eligibility');
    Route::get('/prioritize', [AiController::class, 'prioritizeRequests'])->name('ai.prioritize');
    Route::post('/match-donors', [AiController::class, 'matchDonors'])->name('ai.match-donors');
    Route::get('/chat', function () {
        return view('ai.chat');
    })->name('ai.chat');
    Route::post('/chat', [AiController::class, 'chat'])->name('ai.chat.post');
});